...
async function register(req, res) {
  ...
  try {
    ...
    // it select the user name and user id from the database and check if the username or email already exists and return the user name and user id and set the data on the variable
...
async function login(req, res) {
  ...
  try {
    // Query the user by email or username and the the returnet value on the destructuring assignment
    const [user] = await dbconnection.query(
